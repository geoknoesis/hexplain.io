...
def build(check=False):
    ...
    html = ('<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            sections+'<h2>Primitive preset matrix</h2><p>Each row retains its named public preset. Missing byte order remains unspecified; no platform default is inserted. Width is storage width, not a semantic significant-bit count.</p>'
            '<div role="region" aria-label="Primitive presets" tabindex="0"><table><thead><tr><th>Preset</th><th>Bits</th><th>Signed</th><th>Byte order</th><th>RDF datatype</th></tr></thead><tbody>'+rows+'</tbody></table></div></body></html>\n')
