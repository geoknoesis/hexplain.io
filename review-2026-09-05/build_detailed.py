...
assert 'BUILD SUCCESSFUL' in read(REPOS['engine']/'tests/gdal/results/fix-all-final.log')
assert 'BUILD SUCCESSFUL' in read(OUT/'fix-all-saas-check.log')
