...
page='<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Production acceptance implementation</title><style>body{font:17px/1.6 system-ui;max-width:1000px;margin:40px auto;padding:20px;color:#18323b}article{border-top:1px solid #ccd;padding:20px 0}a{color:#006d60}li{overflow-wrap:anywhere}</style><a href="production-readiness.html">Production-readiness review</a><h1>Implementation progress</h1><p>Scores remain unchanged. Local tooling and tests do not certify deployment or external review.</p><p><a href="../specification/validation/competency-trace.html">Semantic corpus traceability</a> | <a href="../specification/validation/security-mutations.html">Security mutation evidence</a> | <a href="staged-artifact-inventory.json">Staged artifact inventory</a> | <a href="implementation-progress.json">Evidence ledger</a></p><h2>Recorded evidence</h2><ul>'
